...
# Non_Interpolated_Cum<-as.data.frame(rasterToPoints(Data_Cum))
# names(Non_Interpolated_Cum)[3]="Precipitation"
...
# Non_Interpolated_Clim<-as.data.frame(rasterToPoints(Data_Clim))
# names(Non_Interpolated_Clim)[3]="Climatology"
# Non_Interpolated_Clim<-merge(Non_Interpolated_Clim,Non_Interpolated_Cum,by=c("x","y"))
# 
# 
# Non_Interpolated_Clim$RR<-ifelse(Non_Interpolated_Clim$Climatology<=31,NA,(Non_Interpolated_Clim$Precipitation/Non_Interpolated_Clim$Climatology)*100)
# 
# rio::export(Non_Interpolated_Clim[,c("x","y","RR")],paste("Results/Percentage_",Month_name,".csv",sep=""))
